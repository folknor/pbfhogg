...
- [ ] **[notes/testing.md](notes/testing.md)** - test infrastructure and coverage tracker. Open work items (T02 indexdata-trust backlog, T05 deferred parity surfaces, T07 proptest extensions, T08 boundary-twin practice, T09 check-refs parity, T10 cargo-fuzz, truncation alignment, IdSet silent-rejection cleanup) tracked in that file. Historical narrative of how each section was reached lives in `git log -- notes/testing.md`.
