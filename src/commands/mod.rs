...
// gives 3,676,618 decoded bytes/blob. The 64-block overnight suggestion is
// therefore 64 * 3,676,618 = 235,303,552 bytes.
...
{
    let max_bytes = crate::read::pipeline::byte_budget_from_env("PBFHOGG_CMD_BATCH_BYTES")?;
